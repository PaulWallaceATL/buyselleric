...
export function SearchSuggestionsList({
  ...
  return (
    <ul
      ...
      className="absolute left-0 right-0 top-full z-[60] mt-2 max-h-[min(70vh,22rem)] overflow-y-auto rounded-2xl border border-border bg-popover/95 py-1 shadow-xl backdrop-blur-md"
    >
