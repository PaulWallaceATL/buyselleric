...
export function ListingsSearchBar({
  ...
  defaultValue?: string;
  /** Prefill dream prompt from `dream` query param. */
  dreamDefault?: string;
  ...
  return (
    <div className="w-full">
      <div
        className="mb-3 inline-flex rounded-full border border-border bg-muted/20 p-1"
        role="group"
      ...
      {mode === "dream" ? (
        <DreamHomePrompt variant="listings" defaultValue={dreamDefault} />
      ) : (
